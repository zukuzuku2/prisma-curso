 ...
 *
 * @returns
 * @param {boolean} boleano - Tiene que ser de tipo boolean para mostrar o no el console log
 * @param {number} id - Tiene que ser de tipo numerico con el numero del id del user
 */
const primeraCoincidencia = (id, boleano) =>
  prisma.user
    .findFirst({
      where: {
        id: id,
